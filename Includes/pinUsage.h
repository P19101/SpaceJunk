...
#define 	LOW_FREQ_ON_OFF_DEFAULT		ON
#define 	HIGH_FREQ_ON_OFF_DEFAULT	OFF
#define 	VL_FREQ_ON_OFF_DEFAULT		OFF
#define 	SMCLK_ON_OFF_DEFAULT		OFF

// DEFAULT STATE OF CONDITIONAL REQUEST FOR SYSTEM CLOCKS
#define		MOD_CLK_COND_REQ			ENABLED
#define		MCLK_COND_REQ				ENABLED
#define		SMCLK_COND_REQ				ENABLED
#define		ACLK_COND_REQ				ENABLED
